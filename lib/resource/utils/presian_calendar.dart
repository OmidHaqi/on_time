...
class PersianCalendar extends StatefulWidget {
  ...
  @override
  State<PersianCalendar> createState() => _CalendarDatePickerState();
}

class _CalendarDatePickerState extends State<PersianCalendar> {
...
//                           ),
//                         ),
//                         Text('${widget.day.toPersianNumber()} - ${ widget.month.toPesianMonth()} ')
//                       ],
//                     ),
//                   ),
//                 ),
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  void _handleMonthPageChanged(int monthPage) {
    final Jalali monthDate = addMonthsToMonthDate(widget.firstDate, monthPage);
  ...
  Widget _buildItems(BuildContext context, int index) {
    final Jalali month = addMonthsToMonthDate(widget.firstDate, index);
    return _DayPicker(
...
class _DayPicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? dayStyle =
        textTheme.bodySmall?.apply(fontSizeDelta: 12, fontWeightDelta: 3);
    final Color enabledDayColor = colorScheme.onSurface;
    final Color disabledDayColor = colorScheme.onSurface.withOpacity(0.50);
    ...
    final int dayOffset = firstDayOffset(year, month);
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        Widget dayWidget = Container(
          ...
          child: Center(
            child: Text(formatDecimal(day).toPersianNumber(),
